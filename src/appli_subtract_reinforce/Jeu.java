...
public class Jeu {
    ...
    public void init_machine(int t[], int nbcas, int nbc, int c, int p, int r, int vitesse, Adversaire adversaire, int jo) { // init équitable, avec c billes de chaque couleur
        this.c=c;
        this.penalty=p;
        this.reward=r;
    ...
    boolean jouerUnCoup() {
        ...
        if (joueur==0){//à la machine de jouer
            ...
            switch (adversaire){
                case ALEA: j=coup_alea();break;
                case HUMAIN: j=coup_humain();break;
