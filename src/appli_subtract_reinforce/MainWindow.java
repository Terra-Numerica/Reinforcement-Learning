...
{
    MachineDrawing pano_machine ;
    PanneauActions pano_actions;
    PanelScore pano_score;
    Game jeu;
    int musique=-1;
    long clipTime=0;
    ...
    public MainWindow() {
        int t[] = {1, 2};
        jeu = new Game(t, 9);
        jeu.init_machine(t, 9, 2, 6, -1, 3, 0, Opponent.HAZARD, 0);
        new Thread(() -> jeu.partie_humaine()).start();

        pano_machine = new MachineDrawing(jeu);
        pano_actions = new PanneauActions();
        pano_score = new PanelScore(0, 0);
            ...
            amorcer.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent ae) {
                    ...
                    switch (combo.getSelectedIndex()){
                        case 0: adv=Opponent.HAZARD;break;
                        case 1: adv=Opponent.EXPERT;break;
                        case 2: adv=Opponent.MACHINE;break;
                        case 3: adv=Opponent.HUMAN;break;                             
                    }
                    ...
                    if (jeu.vitesse==0){
                        ...
                        if (fin_partie) {
                            if (jeu.joueur==0){//adversaire a gagné
                                ...
                                if (jeu.adversaire==Opponent.MACHINE)
